...
HD_PWD='C:/Users/hrish/Downloads/Wahl_Thesis_Haris_Student_Arbeit/ReRAM_On_FPGA/ReRAM_On_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log trq_adc_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source trq_adc_top.tcl -notrace
