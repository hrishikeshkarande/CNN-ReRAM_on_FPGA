...
HD_PWD='C:/Users/hrish/Downloads/Wahl_Thesis_Haris_Student_Arbeit/ReRAM_On_FPGA/ReRAM_On_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log trq_adc_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source trq_adc_top.tcl
