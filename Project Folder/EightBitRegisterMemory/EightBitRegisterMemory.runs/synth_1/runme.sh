...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/EightBitRegisterMemory/EightBitRegisterMemory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DesignForPStoReg_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DesignForPStoReg_wrapper.tcl
