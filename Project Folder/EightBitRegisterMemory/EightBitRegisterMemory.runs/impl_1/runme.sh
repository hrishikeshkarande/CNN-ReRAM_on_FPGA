...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/EightBitRegisterMemory/EightBitRegisterMemory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DesignForPStoReg_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DesignForPStoReg_wrapper.tcl -notrace
