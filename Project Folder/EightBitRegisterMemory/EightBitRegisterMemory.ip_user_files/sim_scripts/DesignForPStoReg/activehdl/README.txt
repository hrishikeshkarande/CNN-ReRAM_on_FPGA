...
#
# Generated by export_simulation on Sun Oct 05 18:09:41 +0200 2025
#
################################################################################
...
'-reset_run' switch to the './DesignForPStoReg.sh' script.

./DesignForPStoReg.sh -reset_run
...
./DesignForPStoReg.sh -noclean_files

For more information on the script, please type './DesignForPStoReg.sh -help'.
