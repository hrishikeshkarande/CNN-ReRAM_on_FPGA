...
# Using Pmod Header JB (Zybo Z7-20 only)
# Make sure your TM1637 module's CLK and DIO are connected to these pins.
# Refer to the Zybo Z7 Reference Manual for accurate Pmod pinouts.
...
# --- End TM1637 7-segment display pins ---
