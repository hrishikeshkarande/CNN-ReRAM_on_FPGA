...
module reram_core #(
    ...
    output wire failed,
        ...
        // === NEW: Mirror outputs for all cells ===
    output wire [MEM_DEPTH-1:0] cells_busy,
    output wire [MEM_DEPTH-1:0] cells_failed,
    output wire [MEM_DEPTH-1:0] cells_read,
    output wire [MEM_DEPTH-1:0] cells_data_out
);
    ...
    // Mirror internal signals to top-level ports
    assign cells_busy     = cell_busy;
    assign cells_failed   = cell_failed;
    assign cells_read     = cell_read_data;
    assign cells_data_out = cell_data_out;
