...
################################################################
# This is a generated script based on design: RevisionDesign
#
...
# source RevisionDesign_script.tcl
...
set design_name RevisionDesign
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_reram_0, and set properties
  set axi_reram_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_reram:1.0 axi_reram_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_reram_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_reram_0_bram_addrb [get_bd_pins axi_reram_0/bram_addrb] [get_bd_pins blk_mem_gen_0/addrb]
  connect_bd_net -net axi_reram_0_bram_clkb [get_bd_pins axi_reram_0/bram_clkb] [get_bd_pins blk_mem_gen_0/clkb]
  connect_bd_net -net axi_reram_0_bram_dinb [get_bd_pins axi_reram_0/bram_dinb] [get_bd_pins blk_mem_gen_0/dinb]
  connect_bd_net -net axi_reram_0_bram_enb [get_bd_pins axi_reram_0/bram_enb] [get_bd_pins blk_mem_gen_0/enb]
  connect_bd_net -net axi_reram_0_bram_rstb [get_bd_pins axi_reram_0/bram_rstb] [get_bd_pins blk_mem_gen_0/rstb]
  connect_bd_net -net axi_reram_0_bram_web [get_bd_pins axi_reram_0/bram_web] [get_bd_pins blk_mem_gen_0/web]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins axi_reram_0/bram_doutb] [get_bd_pins blk_mem_gen_0/doutb]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_reram_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_reram_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_reram_0/S00_AXI/S00_AXI_reg] SEG_axi_reram_0_S00_AXI_reg
