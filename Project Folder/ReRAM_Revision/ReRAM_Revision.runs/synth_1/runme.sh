...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/ReRAM_Revision/ReRAM_Revision.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RevisionDesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RevisionDesign_wrapper.tcl
