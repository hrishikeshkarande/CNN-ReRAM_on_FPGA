...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/ReRAM_Revision/ReRAM_Revision.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RevisionDesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RevisionDesign_wrapper.tcl -notrace
