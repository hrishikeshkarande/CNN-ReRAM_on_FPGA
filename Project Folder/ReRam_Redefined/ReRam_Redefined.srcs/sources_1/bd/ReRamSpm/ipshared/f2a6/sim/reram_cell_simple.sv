...
module reram_cell_simple #(
    ...
    // Operation tracking
    logic [31:0] target_delay, next_target_delay;
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (current_state == IDLE || (current_state != next_state)) begin
                delay_counter <= 1;
                target_delay <= next_target_delay;
            end else begin
