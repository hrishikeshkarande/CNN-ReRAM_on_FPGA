...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/ReRam_Redefined/ReRam_Redefined.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ReRamSpm_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ReRamSpm_wrapper.tcl -notrace
