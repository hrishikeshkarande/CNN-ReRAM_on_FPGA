...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/ReRam_Redefined/ReRam_Redefined.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ReRamSpm_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ReRamSpm_wrapper.tcl
