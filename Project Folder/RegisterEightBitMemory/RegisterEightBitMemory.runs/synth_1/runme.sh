...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/RegisterEightBitMemory/RegisterEightBitMemory.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log EightBitMemoryBlock_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source EightBitMemoryBlock_wrapper.tcl
