...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/RegisterEightBitMemory/RegisterEightBitMemory.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log EightBitMemoryBlock_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source EightBitMemoryBlock_wrapper.tcl -notrace
