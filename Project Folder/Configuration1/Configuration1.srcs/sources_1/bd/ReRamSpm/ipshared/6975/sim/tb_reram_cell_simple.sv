...
module tb_reram_cell_simple;
    ...
    // >>> TB temps hoisted to module scope for Vivado 2018.1
    ...
    task automatic read_cell(output logic read_value);
        begin
    ...
    task automatic verify_value(input logic expected);
        logic actual;
        begin
            read_cell(actual);
    ...
    task automatic test_timing(input string operation, input int expected_delay);
        ...
        begin
            ...
            if (actual_delay < expected_delay) begin
                ...
                error_count++;
            end else if (actual_delay > expected_delay) begin
                $display("[ERROR] Operation took longer than expected");
            end else begin
    ...
    initial begin
        ...
        error_count = 0;
        test_phase = 0;
        dummy_read = 'x;   // value irrelevant; read_cell writes it
