...
HD_PWD='C:/Users/hrish/Downloads/ReRAM_Thesis/Project Folder/ReRAM_AXI_Project/ReRAM_AXI_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bd_wrapper.tcl
