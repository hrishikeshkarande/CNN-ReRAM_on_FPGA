...
HD_PWD='C:/Users/hrish/Downloads/Wahl Thesis Haris Student Arbeit/Zynq_book_tutorials/led_controller/led_controller.runs/led_test_system_led_controller_0_0_synth_1'
cd "$HD_PWD"
