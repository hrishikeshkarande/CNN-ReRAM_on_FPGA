...
module tb_reram_cell_simple;
    ...
    initial begin
        ...
        //----------------------------------------------------------------------
        // Test Phase 4: Endurance Tracking
        //----------------------------------------------------------------------
        test_phase = 4;
        $display("\n--- Phase 4: Endurance Tracking ---");
        
        // Perform many writes and check counter
        logic [7:0] initial_count = write_cycles;
        ...
        logic [7:0] final_count = write_cycles;
        ...
        //----------------------------------------------------------------------
        // Test Phase 4b: Endurance Error Testing  
        //----------------------------------------------------------------------
        $display("\n--- Phase 4b: Endurance Error Testing ---");
        ...
        $display("Phase 4b completed");

        //----------------------------------------------------------------------
        // Test Phase 5: Error Conditions
        //----------------------------------------------------------------------
        test_phase = 5;
        $display("\n--- Phase 5: Error Condition Testing ---");        // Test concurrent read and write (should be handled gracefully)
        ...
        //----------------------------------------------------------------------
        // Test Phase 6: State Machine Coverage
        //----------------------------------------------------------------------
        test_phase = 6;
        $display("\n--- Phase 6: State Machine Coverage ---");
